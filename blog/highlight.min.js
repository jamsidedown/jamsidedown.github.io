...
},h,m,E,_,v,p,d]}}})();hljs.registerLanguage("fsharp",e)})();/*! `bash` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `openscad` grammar compiled for Highlight.js 11.7.0 */
...
begin:"[*!#%]",relevance:0},a]}}})();hljs.registerLanguage("openscad",e)})();/*! `python` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("markdown",e)})();/*! `nginx` grammar compiled for Highlight.js 11.7.0 */
